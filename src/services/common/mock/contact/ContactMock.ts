  ...
  get<T>(resource: string, options?: IRequestOptions): IRestResponse<T> | null {
    ...
    switch (resource) {
      ...
      case "ua/contact/2":
        ...
        return new MockResponse(mockObj, status);
      case "ua/contact":
        mockObj = <T> new Page(<T[]> [new Contact(1, "Jimmy", "Neutron", new Gender(3, "A"), new Firm(2, "1111111", "La poissonerie des familles", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), new FirmType(4, "SARL")), "jimmy@test.com", "0450202122", "+33620547064", "Stagiaire", "Super sympa", true), new Contact(2, "José", "Bové", new Gender(4, "I"), new Firm(1, "99999999", "La boucherie du Léman", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), new FirmType(2, "TPE/PME")), "votezjosé@test.com", "0405060708", "+33711121314", "PDG", "", false)], new Meta (1, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
      case "ua/contact?firmId=1" :
        mockObj = <T> new Page(<T[]> [new Contact(2, "José", "Bové", new Gender(4, "I"), new Firm(1, "99999999", "La boucherie du Léman", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), new FirmType(2, "TPE/PME")), "votezjosé@test.com", "0405060708", "+33711121314", "PDG", "", false)], new Meta (1, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
      case "ua/contact?firmId=2" :
        mockObj = <T> new Page(<T[]> [new Contact(1, "Jimmy", "Neutron", new Gender(3, "A"), new Firm(2, "1111111", "La poissonerie des familles", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), new FirmType(4, "SARL")), "jimmy@test.com", "0450202122", "+33620547064", "Stagiaire", "Super sympa", true)], new Meta (1, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
    }
    return null;
