  ...
  get<T>(resource: string, options?: IRequestOptions): IRestResponse<T> | null {
    ...
    switch (resource) {
      ...
      case "core/member/2":
        ...
        return new MockResponse(mockObj, status);
      case "core/member":
        mockObj = <T> new Page(<T[]> [new Member(1, "Tom", "Dupont", "tdupont", new Gender(3, "A"), "tom.dupont@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(3, "Secretaire Générale", new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", new Pole(2, "SI", "Système d'informations"))]), new Member(2, "Pierre", "Henry", "phenry", new Gender(1, "H"), "pierre.henry   @test.com", "1996-08-27",  new Department(9, "TC"), 3, "0607080910", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), [new Position(3, "Secretaire Générale", new Pole(1, "RH", "Ressources Humaines")), new Position(2, "Vice-Président(e)", new Pole(1, "RH", "Ressources Humaines"))])], new Meta (2, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
      case "core/member?poleId=1" :
        mockObj = <T> new Page(<T[]> [new Member(1, "Tom", "Dupont", "tdupont", new Gender(3, "A"), "tom.dupont@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(3, "Secretaire Générale", new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", new Pole(2, "SI", "Système d'informations"))]), new Member(2, "Pierre", "Henry", "phenry", new Gender(1, "H"), "pierre.henry   @test.com", "1996-08-27",  new Department(9, "TC"), 3, "0607080910", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), [new Position(3, "Secretaire Générale", new Pole(1, "RH", "Ressources Humaines")), new Position(2, "Vice-Président(e)", new Pole(1, "RH", "Ressources Humaines"))])], new Meta (2, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
      case "core/member?poleId=2" :
        mockObj = <T> new Page(<T[]> [new Member(1, "Tom", "Dupont", "tdupont", new Gender(3, "A"), "tom.dupont@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(3, "Secretaire Générale", new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", new Pole(2, "SI", "Système d'informations"))])], new Meta (2, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
      case "core/member?positionId=10&poleId=1" :
        mockObj = <T> new Page(<T[]> [new Member(1, "Jacques", "Dutronc", "jdutronc", new Gender(3, "A"), "jacques.dutronc@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(10, "Consultant", new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", new Pole(2, "SI", "Système d'informations"))])], new Meta (2, 5, 2 , 25));
        status = 200;
        return new MockResponse(mockObj, status);
      case "core/member?positionId=10" :
        mockObj = <T> new Page(<T[]> [new Member(1, "Jacques", "Dutronc", "jdutronc", new Gender(3, "A"), "jacques.dutronc@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(10, "Consultant", new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", new Pole(2, "SI", "Système d'informations"))])], new Meta (2, 5, 2 , 25));
        status = 200;
    }
    return null;
