    ...
    if (resource.startsWith("core/member?")) {
      switch (resource) {
        case "core/member?pageNumber=0":
          mockObj = <T>new Page(<T[]>[new Member(1, "Tom", "Dupont", "tdupont", new Gender(3, "A"), "tom.dupont@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(3, "Secretaire Générale", 2019, true, new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", 2018, false, new Pole(2, "SI", "Système d'informations"))]), new Member(2, "Pierre", "Henry", "phenry", new Gender(1, "H"), "pierre.henry   @test.com", "1996-08-27", new Department(9, "TC"), 3, "0607080910", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), [new Position(3, "Secretaire Générale", 2019, true, new Pole(1, "RH", "Ressources Humaines")), new Position(2, "Vice-Président(e)", 2019, true, new Pole(1, "RH", "Ressources Humaines"))])], new Meta(0, 2, 4, 25));
          status = 200;
          return new MockResponse(mockObj, status);
        case "core/member?pageNumber=1":
          mockObj = <T>new Page(<T[]>[new Member(2, "Pierre", "Henry", "phenry", new Gender(1, "H"), "pierre.henry   @test.com", "1996-08-27", new Department(9, "TC"), 3, "0607080910", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), [new Position(3, "Secretaire Générale", 2015, true, new Pole(1, "RH", "Ressources Humaines")), new Position(2, "Vice-Président(e)", 2012, true, new Pole(1, "RH", "Ressources Humaines"))]), new Member(1, "Tom", "Dupont", "tdupont", new Gender(3, "A"), "tom.dupont@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(3, "Secretaire Générale", 2019, true, new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", 2019, true, new Pole(2, "SI", "Système d'informations"))])], new Meta(1, 2, 4, 25));
          status = 200;
          return new MockResponse(mockObj, status);
      }
      mockObj = <T>new Page(<T[]>[new Member(1, "Tom", "Dupont", "tdupont", new Gender(3, "A"), "tom.dupont@test.com", "1996-08-27", new Department(1, "BIM"), 3, "0607080910", new Address(1, "37, rue des Lilas", "", "01220", "Grilly", new Country(1, "France")), [new Position(3, "Secretaire Générale", 2015, false, new Pole(1, "RH", "Ressources Humaines")), new Position(4, "Responsable SI", 2015, true, new Pole(2, "SI", "Système d'informations"))]), new Member(2, "Pierre", "Henry", "phenry", new Gender(1, "H"), "pierre.henry   @test.com", "1996-08-27", new Department(9, "TC"), 3, "0607080910", new Address(2, "1204, rue des Acacias", "34, rue de Créqui", "69006", "Lyon", new Country(2, "Suisse")), [new Position(3, "Secretaire Générale", 2019, true, new Pole(1, "RH", "Ressources Humaines")), new Position(2, "Vice-Président(e)", 2019, true, new Pole(1, "RH", "Ressources Humaines"))])], new Meta(0, 2, 5, 25));
      status = 200;
      return new MockResponse(mockObj, status);
    }
    return null;
