    ...
    update<T>(resource: string, resources: any, options?: IRequestOptions): IRestResponse<T> | null {
        ...
        switch (resource) {
            case "sg/consultant-inscription/1" :
                mockObj = <T> new ConsultantInscription(1, resources.firstName, resources.lastName, new Department(resources.departmentId, "TC"), resources.email, new Gender(resources.genderId, "H"), resources.birthday, resources.phoneNumber, resources.outYear, new Country(resources.nationalityId, "France"), resources.address);
                status = 200;
                return new MockResponse(mockObj, status);
            case "sg/consultant-inscription/2" :
                mockObj = <T> new ConsultantInscription(2, resources.firstName, resources.lastName, new Department(resources.departmentId, "IF"), resources.email, new Gender(resources.genderId, "H"), resources.birthday, resources.phoneNumber, resources.outYear, new Country(resources.nationalityId, "France"), resources.address, [new Document(1, "Fiche d'inscription", true, false), new Document(2, "Pièce identité", false, true
